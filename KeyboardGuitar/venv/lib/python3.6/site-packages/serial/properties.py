...
class Enum(Property):
    ...
    + Properties:
        ...
        - values ([Any]|collections.Callable):  A list of possible values, or a function taking one argument (the parent
          object) which returns a list of possible values. If ``value_types`` are specified--typing is
    ...
    def __init__(
        ...
        values=None,  # type: Optional[Union[typing.Sequence, typing.Set, typing.Callable]]
        name=None,  # type: Optional[str]
        required=False,  # type: Union[bool, collections.Callable]
        versions=None,  # type: Optional[typing.Collection]
    ):

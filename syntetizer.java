...
public class syntetizer {

    private static final int DEFAULT_INSTRUMENT = 1;

    private MidiChannel channel;

    public syntetizer() throws MidiUnavailableException {
        this(DEFAULT_INSTRUMENT);
    }

    public syntetizer(int instrument) throws MidiUnavailableException {
    ...
    public static void main(String[] args) throws Exception {
        syntetizer player = new syntetizer();
